<template>
  <section class="cmp-about">
    <div class="menu-header about-header">
      ...
      <h3 @click="closeMenu" class="close-menu material-icons-outlined pointer">
        close
      </h3>
    </div>
    <hr />
    ...
    <div class="description">
      <header>
        <div>
          <h2><span class="icon-description"></span> Description</h2>
        </div>
        <a class="edit-btn" v-if="!editDescription" @click="openEditDescription"
          >Edit</a
        >
      </header>
