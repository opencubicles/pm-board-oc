        ...
        <div class="main-details">
          <div class="header-optional" v-if="headerShow">
            <div class="members" v-if="card.members && card.members.length">
              ...
              <ul class="member-container">
                ...
                <a
                  class="plus-btn"
                  @click="dynamicCmp('members', null, null, $event)"
                >
          ...
          <div class="description">
            ...
            <header>
              ...
              <a
                class="edit-btn"
                v-show="!editDescription && card.description"
            ...
            <div class="attachments-list">
              ...
              >
                <div
                  class="att-container"
                  v-if="
                    getBoard.style.background || getBoard.style.backgroundImage
                  "
                  :style="boardBcg"
                >
                  <div class="att-card" @click="moveCard(attCard.id)">
                    <ul
                      class="att-labels-container"
                      v-if="labelByCardSyn(attCard).length"
                    >
                      <li
                        v-for="label in labelByCardSyn(attCard)"
                        :key="label.id"
                      >
                        <span
                          class="att-label"
                    ...
                    <div class="att-card-icon">
                      ...
                      >
                        <span
                          class="due-date-icon att-icon el-icon-time check"
                        ></span>
                      ...
                      <span
                        v-if="
                          attCard.description && attCard.description.length > 0
                        "
                      ...
                      <span
                        v-if="
                          attCard.attachment.computerAttachment &&
                          attCard.attachment.computerAttachment.length > 0
                        "
                      ...
                      <!-- checklist -->
                      <span
                        class="checklist att-icon"
                        v-if="
                          attCard.checklists && attCard.checklists.length > 0
                        "
                      >
                        <span class="material-icons-outlined att-icon">
                          check_box</span
                        >
                        <span v-if="doneTodosAmount">{{
                          doneTodosAmount
                        }}</span>
                        <span>/</span>
                      ...
                      <!-- comments  -->
                      <span
                        v-if="attCard.comments && attCard.comments.length > 0"
                      >
                        <span class="el-icon-chat-round att-icon"></span
                        >{{ attCard.comment }}</span
                      >
                    </div>
                    <div
                      class="att-card-avatar"
                ...
                <a @click="removeMsg(attCard.id, $event)" class="att-remove"
                  >remove</a
                >
                <!--  -->
              ...
              <span v-if="attTrLongLength > 4">
                ...
                <a class="view view-short" @click="toggleAttTr" v-else
                  >Show fewer Trello attachments.
                </a>
              </span>
            </div>
            <a
              class="addAttTr"
              @click="dynamicCmp('trelix', null, null, $event)"
              >Add Trelix attachment</a
            >
          </div>
          ...
          >
                ...
                <div class="attachment-option-container">
                  <p class="attachment-option">
                    ...
                    <span class="title-option">
                      ...
                      <span class="title-option-container">
                        <a
                          ...
                          @click.stop="addLinkToActivity(att.url)"
                          >Comment</a
                        >
                        -
                        <a
                    ...
                    <span
                      v-if="att.url"
                      class="cover"
                      @click.stop="makeCover(`url(${att.url})`)"
                    >
            ...
            <p class="longAtt">
              ...
              >
              <a v-if="logAtt" @click="logAtt = false"
                >Show fewer attachments.</a
              >
            </p>
            <a
              class="add-item"
              @click="dynamicCmp('attachment', null, null, $event)"
              >Add an attachment</a
            >
          </div>
...
export default {
  ...
  methods: {
    ...
    removeAttTrelix() {
      let card = JSON.parse(JSON.stringify(this.card));
      const cardIdx = card.attachment.trelixAttachments.findIndex(
        (a) => a === this.attTrToDeleteId
      );
  ...
  computed: {
    dueDateTime() {
      return moment(this.card.dueDate.date.date, "YYYY-MM-DD").format(
        "MMM DD,YYYY"
      );
    },
    attTrelix() {
      ...
      return this.attTrLong && cardAttTrelix.length > 4
        ? cardAttTrelix
        : cardAttTrelix.splice(0, 4);
    },
    dynamicCmpToShow() {
      return this.cmp.cmp;
    },
    ...
    cardAttachments() {
      let computerAttachment = JSON.parse(
